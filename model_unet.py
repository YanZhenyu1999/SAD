...
class Discriminator(nn.Module):
    def __init__(self, in_channels=3, base_width=64):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels, base_width, kernel_size=5, padding=2),
            nn.BatchNorm2d(base_width, eps=1e-04, affine=False),
            nn.LeakyReLU(0.2, inplace=True))
        self.conv2 = nn.Sequential(
            nn.Conv2d(base_width, base_width * 2, kernel_size=5, padding=2),
            nn.BatchNorm2d(base_width*2, eps=1e-04, affine=False),
            nn.LeakyReLU(0.2, inplace=True))
        self.conv3 = nn.Sequential(
            nn.Conv2d(base_width * 2, base_width * 4, kernel_size=5, padding=2),
            nn.BatchNorm2d(base_width * 4, eps=1e-04, affine=False),
            nn.LeakyReLU(0.2, inplace=True))
        self.conv4 = nn.Sequential(
            nn.Conv2d(base_width * 4, base_width * 8, kernel_size=5, padding=2),
            nn.BatchNorm2d(base_width * 8, eps=1e-04, affine=False),
            nn.LeakyReLU(0.2, inplace=True))
        self.avgpool = nn.AdaptiveAvgPool2d((1,1))
        self.layer1 = nn.Linear(base_width * 8, 1)
